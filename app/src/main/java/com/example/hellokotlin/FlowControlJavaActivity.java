    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLD.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (number % 2 == 0){
                    Toast.makeText(getApplicationContext(),"" + number + "은(는) 2의 배수이다.", Toast.LENGTH_SHORT).show();
                }
                else if(number % 3 ==0){
                    Toast.makeText(getApplicationContext(),"" + number + "은(는) 3의 배수이다.", Toast.LENGTH_SHORT).show();
                }
                else {
                ...
                switch (number){
                    case 4:
                    case 9: btnLD.setText("실행 for 4 or 9");
                    break;
